...
function add_theme_scripts() {
  ...
  wp_enqueue_style( 'line-awesome-css', get_template_directory_uri() . '/assets/css/line-awesome.css');
...
function custom_post_type() {
    $labels = array(
        ...
        'update_item'         => __( 'Update Products', 'twentytwenty' ),
...
// Set other options for Custom Post Type
    ...
    $args = array(
        ...
        'description'         => __( 'Products news and reviews', 'twentytwenty' ),
        'labels'              => $labels,
